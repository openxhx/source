namespace anniversary {
    export class MtfhBuyPanel extends ui.anniversary.panel.MtfhBuyPanelUI {
        ...
        private buy() {
            clientCore.RechargeManager.pay(42).then((data) => {
                ...
                // clientCore.MedalManager.setMedal([{ id: MedalConst.ANNIVERSARY_MEDAL_ACTIVE, value: 1 }]);
                this.onClose();
                EventManager.event("MTFH_MEDAL_ACTIVE");
            });
        }
