namespace summerDream {
    export class TenRewardPanel extends ui.summerDream.panel.TenPanelUI {
        private _reward: ui.summerDream.item.TenItemRenderUI[];
        ...
        private async showRewardList(infos: pb.IdrawReward[]) {
            for (let i = 0; i < infos.length; i++) {
                ...
                let mc = new ui.summerDream.item.TenItemRenderUI();
        ...
        private waitRewardAni(mc: ui.summerDream.item.TenItemRenderUI) {
        ...
        private setRewardUI(mc: ui.summerDream.item.TenItemRenderUI, info: RewardInfo) {
            if (info.decomp) {
