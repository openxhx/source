namespace summerDream {
    export class ActLimitPanel extends ui.summerDream.panel.SDActLimitUI {
        private readonly suitId: number = 2110382;
        ...
        constructor() {
            ...
            this.getBuyInfo();
            this.labPrice.text = "360";
            this.addEventListeners();
        }

        private buyInfoRender(item: ui.summerDream.item.BuyInfoRenderUI) {
        ...
        private offInfoRender(item: ui.summerDream.item.LimitInfoRenderUI) {
            let off: number = item.dataSource;
            item.imgFlag.skin = (off >= this.curOff && this.curOff > 0) ? "summerDream/re_mai_zhong.png" : "summerDream/yi_shou_wan.png"
        ...
        async show() {
            ...
            clientCore.Logger.sendLog('2021年5月28日活动', '【付费】夏夜如梦', '打开雏菊花语面板');
            this.visible = true;
        }
        ...
        private setUI() {
            ...
            this.imgOff.skin = `summerDream/dang_qian${this.curOff}_zhe.png`;
            this.listOffInfo.refresh();
        }

        /**检查开卖时间 */
        private checkSell(): number {
            let endT: number = util.TimeUtil.formatTimeStrToSec("2021/5/28 18:00:00");
        ...
        private buySuit() {
            ...
            alert.showSmall(`是否花费${cost}灵豆购买雏菊花语套装？`, {
                callBack: {
