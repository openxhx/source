namespace foreignLandsRank{
    /**
     * 异域王座排行榜
     * foreignLandsRank.ForeignLandsRankModule
     */
    export class ForeignLandsRankModule extends ui.foreignLandsRank.ForeignLandsRankModuleUI{
        ...
        private listRender(item: ui.foreignLandsRank.RankItemUI,index: number): void{
            ...
            if(isTop3)
                item.imgRank.skin = `foreignLandsRank/top${info.msg.ranking}.png`;   
            else
        ...
        /** 坐骑预览*/
        private onTry(): void{
            clientCore.ModuleManager.open('previewBG.PreviewBGModule', { id: 1200018 ,condition: '阿尔戈之舟坐骑',limit: '前十奖励'});
        }
