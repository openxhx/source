namespace snowNightFestival {
    export class TenRewardPanel extends ui.snowNightFestival.panel.TenPanelUI {
        private _reward: ui.snowNightFestival.render.TenItemRenderUI[];
        ...
        private async showRewardList(infos: pb.IdrawReward[]) {
            for (let i = 0; i < infos.length; i++) {
                ...
                let mc = new ui.snowNightFestival.render.TenItemRenderUI();
        ...
        private waitRewardAni(mc: ui.snowNightFestival.render.TenItemRenderUI) {
        ...
        private setRewardUI(mc: ui.snowNightFestival.render.TenItemRenderUI, info: RewardInfo) {
            if (info.decomp) {
