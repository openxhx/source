namespace pirateBucket {
    export class TenRewardPanel extends ui.pirateBucket.panel.TenPanelUI {
        private _reward: ui.pirateBucket.render.TenItemRenderUI[];
        ...
        private async showRewardList(infos: pb.IdrawReward[]) {
            for (let i = 0; i < infos.length; i++) {
                ...
                let mc = new ui.pirateBucket.render.TenItemRenderUI();
        ...
        private waitRewardAni(mc: ui.pirateBucket.render.TenItemRenderUI) {
        ...
        private setRewardUI(mc: ui.pirateBucket.render.TenItemRenderUI, info: RewardInfo) {
            if (info.decomp) {
