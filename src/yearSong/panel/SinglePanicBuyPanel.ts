namespace yearSong {
    export class SinglePanicBuyPanel extends ui.yearSong.panel.SinglePanicBuyPanelUI {
        private readonly suitId: number = 2110538;
        ...
        private buyInfoRender(item: ui.yearSong.render.PanicInfoRenderUI) {
        ...
        private offInfoRender(item: ui.yearSong.render.LimitInfoRenderUI) {
            ...
            item.imgFlag.skin = (off >= this.curOff && this.curOff > 0) ? "yearSong/SinglePanicBuyPanel/re_mai_zhong.png" : "yearSong/SinglePanicBuyPanel/yi_shou_wan.png"
        ...
        async show() {
            ...
            clientCore.Logger.sendLog('2021年11月19日活动', '【付费】岁月如歌', '打开天籁之音-魅影蓝蝶面板');
        }
        ...
        private setUI() {
            ...
            this.imgOff.skin = `yearSong/SinglePanicBuyPanel/dang_qian${this.curOff}_zhe.png`;
            this.listOffInfo.refresh();
        }

        /**检查开卖时间 */
        private checkSell(): number {
            let endT: number = util.TimeUtil.formatTimeStrToSec("2021/11/19 20:10:00");
        ...
        private buySuit() {
            ...
            alert.showSmall(`是否花费${cost}${clientCore.ItemsInfo.getItemName(YearSongModel.instance.coinid)}购买${clientCore.ItemsInfo.getItemName(this.suitId)}?`, {
                callBack: {
                    caller: this, funArr: [async () => {
                        ...
                        if (res) {
                            YearSongModel.instance.coinCost(cost);
