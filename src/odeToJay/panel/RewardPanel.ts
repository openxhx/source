namespace odeToJay {
     ...
     * 奖励
     */
    export class RewardPanel extends ui.odeToJay.panel.RewardPanelUI {
        ...
        private itemRender(item: ui.commonUI.item.RewardItemUI, index: number): void {
            let array: string[] = this.list.array[index].split('_');
            let id: number = parseInt(array[0]);
            ...
            item.num.value = util.StringUtils.parseNumFontValue(num);
