namespace catchFish {
     ...
     */
    export class CatchFishGameModule extends ui.catchFish.CatchFishModuleUI {
        /**基础速度 */
        ...
        /**关卡分数界限 */
        private readonly levelCfg: number[] = [10, 20, 30, 40, 50, 70, 90];
        /**渔网耐久界限 */
        ...
        onPreloadOver() {
            ...
            this.curLevel = 1;
            this.labLevel.text = `目标关卡1/${this.target}`;
        ...
        private async gameOver() {
            ...
            this._waiting = true;
            net.sendAndWait(new pb.cs_mini_game_collect_over({ id: this.gameId, score: this.curLevel })).then((msg: pb.sc_mini_game_collect_over) => {
        ...
        private getFish() {
            ...
            if (this._score >= this.levelCfg[this.curLevel - 1]) {
                ...
                this.curLevel++;
                if (this.curLevel > this.target) {
                    this.gameOver();
                    return;
                }
                this._durability = 100;
                this.labLevel.text = `目标关卡${this.curLevel}/${this.target}`;
                this.labTarget.text = "" + this.levelCfg[this.curLevel - 1];
                this.clearFish();
                this.startGame();
            }
