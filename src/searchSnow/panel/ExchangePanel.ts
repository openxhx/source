namespace searchSnow {
    export class ExchangePanel extends ui.searchSnow.panel.ExchangePanelUI {
        ...
        private onTab(index: number): void {
            this.tab1.skin = index == 0 ? "searchSnow/clip_l_w_1.png" : "searchSnow/clip_l_w_2.png";
            this.tab2.skin = index == 1 ? "searchSnow/clip_l_w_1.png" : "searchSnow/clip_l_w_2.png";
