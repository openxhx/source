namespace tigerMagic {
    /**
     * 12.17
     * tigerMagic.ClothExchangePanel
     */
    export class ClothExchangePanel extends ui.tigerMagic.panel.ClothExchangePanelUI {
        ...
        init(d: { suitId: number, startId: number, endId: number, iconId: number }) {
            ...
            this.imgSuit.skin = `unpack/tigerMagic/ExchangePanel/${this.curSuit}_${clientCore.LocalInfo.sex}.png`;
        ...
        /**render设置 */
        private ListRender(item: ui.tigerMagic.render.ExchangeRenderUI) {
            ...
            item.imgCost3.skin = clientCore.ItemsInfo.getItemIconUrl(cost[2].v1);
            ...
            let have3 = clientCore.ItemsInfo.getItemNum(cost[2].v1);
            item.labCost1.text = " " + have1 + "/" + cost[0].v2;
            item.labCost2.text = " " + have2 + "/" + cost[1].v2;
            item.labCost3.text = " " + have3 + "/" + cost[2].v2;
            ...
            BC.removeEvent(this, item.imgCost3, Laya.Event.CLICK, this, this.ShowItemTip);
            ...
            BC.addEvent(this, item.imgCost3, Laya.Event.CLICK, this, this.ShowItemTip, [item.imgCost3, cost[2].v1]);
            ...
            if (have1 >= cost[0].v2 && have2 >= cost[1].v2 && have3 >= cost[2].v2 && !item.imgGot.visible) {
                item.btnExchange.visible = true;
                item.imgEqual.skin = "tigerMagic/ExchangePanel/equal1.png";
                item.diTarget.skin = "tigerMagic/ExchangePanel/di_item1.png";
            } else {
                item.btnExchange.visible = false;
                item.imgEqual.skin = "tigerMagic/ExchangePanel/equal.png";
                item.diTarget.skin = "tigerMagic/ExchangePanel/di_item.png";
            }
        }
        ...
        private Exchange(id: number) {
            ...
            EventManager.off(globalEvent.ITEM_BAG_CHANGE, this, this.freshCoinInfo);
            net.sendAndWait(new pb.cs_common_exchange({ exchangeId: id, activityId: 220 })).then((msg: pb.sc_common_exchange) => {
