namespace snowSeason {
     ...
     * 银光耀眼
     */
    export class DisCountDrawPanel extends ui.snowSeason.panel.DisCountDrawPanelUI {

        private _rotating: boolean = false;
        private _suitId: number = 2110565;
        private _giftIdArr: number[] = [1100116, 1000168];
        constructor() {
            super();
        ...
        async show() {
            ...
            clientCore.Logger.sendLog('2021年12月31日活动', '【付费】初雪的季节', '打开银光耀眼面板');
            await net.sendAndWait(new pb.cs_star_sakura({ activeId: SnowSeasonModel.instance.activityId, stage: 1 })).then((data: pb.sc_star_sakura) => {
        ...
        private sureBuy() {
            ...
            net.sendAndWait(new pb.cs_star_sakura_buy_clothes({ activeId: SnowSeasonModel.instance.activityId, stage: 1 })).then((data: pb.sc_star_sakura_buy_clothes) => {
        ...
        private onSuit(i:number) {
            if(i == 0){
                ...
                clientCore.ModuleManager.open('rewardDetail.PreviewModule', 141946);
            }
        }
        ...
        private startTurn() {
            this._rotating = true;
            net.sendAndWait(new pb.cs_refresh_star_sakura({ activeId: SnowSeasonModel.instance.activityId, stage: 1 })).then((data: pb.sc_refresh_star_sakura) => {
        ...
        private openOther() {
            EventManager.event('SnowSeason_SHOW_EVENT_PANEL', panelType.disCountDrawNew);
        }
