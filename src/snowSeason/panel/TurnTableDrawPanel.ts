namespace snowSeason {
    export class TurnTableDrawPanel extends ui.snowSeason.panel.TurnTableDrawPanelUI {
        /** 抽奖功能ID*/
        private _poolId: number = 26;
        /** 抽奖使用的道具ID*/
        private _costItemId: number = 9900283;
        /**套装ID */
        private _suitId: number = 2100347;
        /**集齐奖励ID */
        private _giftId1: number = 1000167;
        private _giftId2: number = 1100115;
        /**充值礼包标志 */
        /**帮助说明id */
        ...
        constructor() {
            ...
            clientCore.Logger.sendLog('2021年12月24日活动', '【付费】初雪的季节', '打开冬日扭蛋-圣诞旋律面板');
        }
        ...
        async show() {
            ...
            this.addPreLoad(clientCore.MedalManager.getMedal([MedalConst.SNOW_SEASON_TURN]).then((msg: pb.ICommonData[]) => {
                if (msg[0].value == 0) {
        ...
        private openOther(i: number) {
            if (i == 1) {
                ...
                EventManager.event('SnowSeason_SHOW_EVENT_PANEL', panelType.rollCard);
            }
        }

        private openDraw() {
            clientCore.MedalManager.setMedal([{ id: MedalConst.SNOW_SEASON_TURN, value: 1 }]);
            BC.removeEvent(this, this.btnStart, Laya.Event.CLICK, this, this.openDraw);
        ...
        addEventListeners(): void {
            ...
            BC.addEvent(this, this.btnStart, Laya.Event.CLICK, this, this.openDraw);
