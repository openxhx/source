namespace snowSeason {
    export class SnowSeasonBuyPanel extends ui.snowSeason.panel.SnowSeasonGiftPanelUI{
        ...
        private async onClick(i: number) {
            ...
            if (i >= 1) {
                ...
                net.sendAndWait(new pb.cs_common_buy({ activityId: SnowSeasonModel.instance.activityId })).then((msg: pb.sc_common_buy) => {
