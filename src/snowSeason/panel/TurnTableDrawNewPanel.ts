namespace snowSeason {
    export class TurnTableDrawNewPanel extends ui.snowSeason.panel.TurnTableDrawNewPanelUI {
        /** 抽奖功能ID*/
        private _poolId: number = 24;
        /** 抽奖使用的道具ID*/
        private _costItemId: number = SnowSeasonModel.instance.coinid;
        /**套装ID */
        private _suitId: number = 2100251;
        /**集齐奖励ID */
        private _giftId1: number = 1000056;
        private _giftId2: number = 3500026;
        /**充值礼包标志 */
        /**帮助说明id */
        ...
        constructor() {
            ...
            this.imgSuit1.visible = this.imgEye1.visible = this.suit_nv.visible = clientCore.LocalInfo.sex == 1;
            this.imgSuit2.visible = this.imgEye2.visible =this.suit_nan.visible = clientCore.LocalInfo.sex == 2;
            this.addEventListeners();
            clientCore.Logger.sendLog('2021年12月17日活动', '【付费】初雪的季节', '打开雪花小铺-复出扭蛋面板');
        }
        ...
        async show() {
            ...
            this.addPreLoad(clientCore.MedalManager.getMedal([MedalConst.SNOW_SEASON_DRAW]).then((msg: pb.ICommonData[]) => {
                if(msg[0].value== 0){
        ...
        private openDraw() {
            clientCore.MedalManager.setMedal([{ id: MedalConst.SNOW_SEASON_DRAW, value: 1 }]);
            BC.removeEvent(this, this.openBtn, Laya.Event.CLICK, this, this.openDraw);
            Laya.Tween.to(this.subBox, { x: 578 }, 2000, Laya.Ease.cubicInOut, new Laya.Handler(this, () => {
                this.subBox.visible = false;
                this.mainBox.visible = true;
             }));
        }
        ...
        addEventListeners(): void {
            ...
            BC.addEvent(this, this.openBtn, Laya.Event.CLICK, this, this.openDraw);
            BC.addEvent(this, this.selectBtn, Laya.Event.CLICK, this, this.openChange);
            BC.addEvent(this, this.tryBtn, Laya.Event.CLICK, this,this.onTry, [1]);
            BC.addEvent(this, this.btn0, Laya.Event.CLICK, this, this.openOther , [2]);
        }
        ...
        private onTry(index: number): void {
            switch (index) {
                case 1:
                    ...
                    break;
                case 2:
                    clientCore.ModuleManager.open('previewBG.PreviewBGModule', { id: [this._giftId1], condition: '奖池集齐可获得' });
                    break;
            }
        }
        /**打开礼包购买面板 */
