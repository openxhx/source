namespace callPlayer2 {
     ...
     * 2020年11月13日
     * 守望忆时光二期
     * callPlayer2.CallPlayer2Module
     */
    export class CallPlayer2Module extends ui.callPlayer2.CallPlayerModuleUI {
        private _model: CallPlayer2Model;
        private _control: CallPlayer2Control;

        private writePanel: CallPlayerPanel;
        private rewardPanel: CallRewardPanel;
        init(data: any) {
            this.sign = clientCore.CManager.regSign(new CallPlayer2Model(), new CallPlayer2Control());
            this._model = clientCore.CManager.getModel(this.sign) as CallPlayer2Model;
            this._control = clientCore.CManager.getControl(this.sign) as CallPlayer2Control;
        ...
        onPreloadOver() {
            clientCore.Logger.sendLog('2020年11月13日活动', '【老玩家召回】守望忆拾光', '打开活动面板');
        ...
        private async getActReward() {
            ...
            util.RedPoint.reqRedPointRefresh(19502);
        ...
        private async getDayReward() {
            ...
            util.RedPoint.reqRedPointRefresh(19503);
        }
        ...
        private async getCallReward() {
            ...
            util.RedPoint.reqRedPointRefresh(19501);
            alert.showReward(arr);
        ...
        private openWritePanel() {
            ...
            clientCore.Logger.sendLog('2020年11月13日活动', '【老玩家召回】守望忆拾光', '打开拾光邀请面板');
        }
        ...
        private openSuitBuy() {
            ...
            clientCore.ModuleManager.open("callSuit2.CallSuit2Module", null, { openWhenClose: "callPlayer2.CallPlayer2Module" });
        }
