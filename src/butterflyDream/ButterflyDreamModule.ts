namespace butterflyDream {
    ...
    const SUIT_ID = 2100287;
    const BG_ID = 1000065;

    /**
     * 蝶之魇   
     * 2021.2.26
     * butterflyDream.ButterflyDreamModule
     */
    export class ButterflyDreamModule extends ui.butterflyDream.ButterflyDreamModuleUI {
        ...
        init(d: any) {
            ...
            this.imgRole.skin = clientCore.LocalInfo.sex == 1 ? 'unpack/butterflyDream/girl.png' : 'unpack/butterflyDream/boy.png';
            clientCore.UIManager.setMoneyIds([clientCore.MoneyManager.SPIRIT_BEAN_MONEY_ID]);
            clientCore.UIManager.showCoinBox();
        }

        onPreloadOver() {
            clientCore.Logger.sendLog('2021年2月26日活动', '【付费】蝶之魇', '打开活动面板');
            this.updateView();
        }
