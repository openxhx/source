namespace stealingHeart {
    /**
    * 偷心大作战奖励item
    * stealingHeart.StealingHeartRender
    */
    export class StealingHeartRender {
        private _data: any;

        private _panel: ui.stealingHeart.render.StealingHeartRenderUI;
        ...
        public init(d: any): void {
            ...
            if (this._data.awards.length > 1) {
                this._panel.ico.skin = "stealingHeart/" + this._data.awards[0].v1 + ".png";
            } else {
