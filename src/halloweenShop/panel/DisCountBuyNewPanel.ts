namespace halloweenShop {
     ...
     * 直购，特惠价
     */
    export class DisCountBuyNewPanel extends ui.halloweenShop.panel.DisCountBuyNewPanelUI {

        private buyId3: number = 2969;
        private suit1: number = 2110522;
        private giftId: number = 1000157;
        ...
        async show() {
            ...
            clientCore.Logger.sendLog('2021年11月5日活动', '【付费】搞怪糖果商城', '打开糖出鬼没面板');
        }
        ...
        /**领取赠品 */
        private getGift() {
            net.sendAndWait(new pb.cs_common_recharge_get_ext_reward({stage: 2 , activityId:202 , index:7})).then((msg: pb.sc_common_recharge_get_ext_reward) => {
                alert.showReward(msg.items);
        ...
        private changePanel(){
            EventManager.event('HalloweenShop_SHOW_EVENT_PANEL', panelType.disCountBuy);
        }
