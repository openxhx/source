namespace halloweenShop {
    export class TurnTableDrawPanel extends ui.halloweenShop.panel.TurnTableDrawPanelUI {
        /** 抽奖功能ID*/
        private _poolId: number = 20;
        /** 抽奖使用的道具ID*/
        private _costItemId: number = 9900261;
        /**套装ID */
        private _suitId: number = 2110281;
        /**集齐奖励ID */
        private _giftId: number = 132806;
        private _giftId1: number = 1100073;
        /**充值礼包标志 */
        /**帮助说明id */
        ...
        constructor() {
            ...
            this._giftId = clientCore.LocalInfo.sex == 1 ? 132806 : 132815;
            this.addEventListeners();
            clientCore.Logger.sendLog('2021年10月15日活动', '【付费】岁月如歌', '打开莺声婉转面板');
        }
        ...
        private initView(): void {
            ...
            //格子初始化
            this._array = _.filter(xls.get(xls.rouletteDraw).getValues(), (element: xls.rouletteDraw) => { return element.type == 202 && element.period == this._poolId; });
            this._cost = _.filter(xls.get(xls.rouletteDrawCost).getValues(), (element: xls.rouletteDrawCost) => { return element.type == 202 && element.period == this._poolId });
        ...
        addEventListeners(): void {
            ...
            BC.addEvent(this, this.btnTryCloth, Laya.Event.CLICK, this, this.onTry, [3]);
        ...
        private onTry(index: number): void {
            switch (index) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    clientCore.ModuleManager.open("rewardDetail.PreviewModule", this._giftId);
                    break;
            }
        }
        /**打开礼包购买面板 */
        ...
        private updateCurrent(): void {
            ...
            if (this.boxCurrent.visible) {
                this.imgCurOff.skin = `halloweenShop/TurnTableDrawPanel/${this.curDiscount / 10}.png`;
            }
        }
        ...
        private playDiscountAni(discount: number) {
            this.imgNextOff.skin = `halloweenShop/TurnTableDrawPanel/xia_hui${discount / 10}_zhe.png`;
            // return new Promise((suc: Function) => {
