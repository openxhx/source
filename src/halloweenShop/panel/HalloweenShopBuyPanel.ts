namespace halloweenShop {
    export class HalloweenShopBuyPanel extends ui.halloweenShop.panel.HalloweenShopBuyPanelUI {

        private eventId: number[] = [6, 7, 8];
        ...
        public async setData() {
            ...
            this["numTxt0"].text = `${1 - timeArr[timeArr.length - 1]}/1`;
            this["buyBtn0"].disabled = timeArr[timeArr.length - 1] >= 1;
        }
        ...
        private async onClick(i: number) {
            ...
            if (i >= 1) {
                ...
                net.sendAndWait(new pb.cs_common_buy({ activityId: 202 })).then((msg: pb.sc_common_buy) => {
                    alert.showReward(msg.item);
                    this["numTxt0"].text = `0/1`;
                    this["buyBtn0"].disabled = true;
                    clientCore.LimitRechargeManager.instance.settimes(this.length-1, 1);
                })
