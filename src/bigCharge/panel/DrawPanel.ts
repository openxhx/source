namespace bigCharge {
     ...
     * 祈愿蛇仙、本周主打
     */
    export class DrawPanel extends ui.bigCharge.panel.DrawPanelUI {
        /** 抽奖ID*/
        readonly DRAW_ID: number = 11;
        /**概率id */
        readonly PROBABILITY_ID: number = 26;
        /** 抽奖使用的道具ID*/
        readonly DRAW_ITEM_ID: number = 9900215;
        readonly SUIT_ID: number[] = [2110435, 2100309, 2110461, 2110462];
        readonly GIFT_ID: number = 3500068;
        private ruleId: number = 1156;
        private _chargeFlag: rollColetionCharge = rollColetionCharge.mofa;
        ...
        show() {
            ...
            this.checkGift();
            clientCore.Logger.sendLog('2021年8月13日活动', '【付费】夏日终曲第七期', '打开本周主打面板');
        }
        ...
        /**领取赠品 */
        private getGift() {
            net.sendAndWait(new pb.cs_summer_recharge_get_extra_reward({ type: 11 })).then((msg: pb.sc_summer_recharge_get_extra_reward) => {
