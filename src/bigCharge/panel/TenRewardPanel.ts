namespace bigCharge {
    export class TenRewardPanel extends ui.bigCharge.panel.TenPanelUI {
        private _reward: ui.bigCharge.render.TenItemRenderUI[];
        ...
        private async showRewardList(infos: pb.IdrawReward[]) {
            for (let i = 0; i < infos.length; i++) {
                ...
                let mc = new ui.bigCharge.render.TenItemRenderUI();
        ...
        private waitRewardAni(mc: ui.bigCharge.render.TenItemRenderUI) {
        ...
        private setRewardUI(mc: ui.bigCharge.render.TenItemRenderUI, info: RewardInfo) {
            if (info.decomp) {
