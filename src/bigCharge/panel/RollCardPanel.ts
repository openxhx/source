namespace bigCharge {
    export class RollCardPanel extends ui.bigCharge.panel.RollCardPanelUI {
        /**套装id */
        private suitId: number = 2110469;
        /**规则id */
        private tips_Id: number = 1161;
        /**概率id */
        private probabilityId: number = 28;
        /**抽奖功能id */
        ...
        async show() {
            ...
            clientCore.Logger.sendLog('2021年8月20日活动', '【付费】夏日终曲第八期', '打开九重盛夏面板');
        }
        ...
        private updateReset(): void {
            ...
            this.btnReset.fontSkin = first ? "bigCharge/RollCardPanel/kai_shi_zhan_bu.png" : "bigCharge/RollCardPanel/chong_zhi.png";
        ...
        private showCard(card: ui.bigCharge.render.RollCardRenderUI, id: number): void {
            if (id < 10000) {
                ...
                card.ico.skin = `bigCharge/RollCardPanel/${['x2', 'x3', 'x5'][index]}.png`;
                card.ico.scale(1, 1);
            }
        }
        ...
        private resetCard(): void {
            ...
            this.netResetCard(this.curPool, new Laya.Handler(this, (data: number[]) => {
                ...
                if (this.isFirstOpen == 0) {
                    ...
                    BigChargeModel.instance.coinCost(this._cls.reloadCost.v2 / 5, false);
                }
                this.showCards();
                this.onSelectCards(-1);
            }))
        ...
        private onCard(pos: number): void {
            ...
            this.openCard(this.curPool, pos, new Laya.Handler(this, async (data: pb.sc_flower_field_market_orange_divine) => {
                ...
                BigChargeModel.instance.coinCost(parseInt(this.txCost.text) / 5, false);
