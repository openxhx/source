namespace dbfEvent {
    export class TenRewardPanel extends ui.dbfEvent.panel.TenPanel1UI {
        private _reward: ui.luckyDrawActivity.render.TenItemRenderUI[];
        ...
        private async showRewardList(infos: pb.IdrawReward[]) {
            for (let i = 0; i < infos.length; i++) {
                ...
                let partsIds: number[] = clientCore.SuitsInfo.getSuitInfo(2100066).clothes;
