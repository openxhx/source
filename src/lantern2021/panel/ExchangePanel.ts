namespace lantern2021{
     ...
     * 奖励兑换
     */
    export class ExchangePanel extends ui.lantern2021.panel.ExchangePanelUI implements IPanel{
        ...
        show(sign: number): void{
            ...
            this.onTab(0);
            clientCore.UIManager.setMoneyIds([this._model.EXCHANGE_ITEM_ID,1540102]);
        ...
        private onTry(): void{
            clientCore.ModuleManager.open("rewardDetail.PreviewModule", 2110288);
        }
        private eListRender(item: ui.lantern2021.item.ExchangeItemUI,index: number): void{
