namespace jumpGame {
    export class JumpPlayer extends ui.jumpGame.item.PlayerItemUI {
        ...
        constructor() {
            ...
            this.imgAddScore.visible = false;
        }
        ...
        showScore(num: number) {
            this.imgAddScore.visible = true;
            this.imgAddScore.x = -18;
            this.imgAddScore.y = -228;
            this.imgAddScore.scaleX = this.imgAddScore.scaleY = 1;
            this.imgAddScore.value = "+" + num;
            Laya.Tween.to(this.imgAddScore, { y: this.imgAddScore.y - 50, scaleX: 1.5, scaleY: 1.5 }, 500, Laya.Ease.linearIn, new Laya.Handler(this, () => {
                this.imgAddScore.visible = false;
            }));
        }
        destroy() {
