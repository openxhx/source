namespace flowerMass {
     ...
     * 转盘抽衣服
     */
    export class RollClothPanel2 extends ui.flowerMass.panel.RollClothPanel2UI {
        /** 抽奖功能ID*/
        private _poolId: number = 40;
        /** 抽奖使用的道具ID*/
        private _costItemId: number = 9900333;
        /**套装ID */
        private _suitId: number = 2100363;
        /**集齐奖励ID */
        private _giftId1: number[] = [2500078 , 300445];
        ...
        constructor() {
            ...
            this.imgFaceReward.skin = clientCore.LocalInfo.sex == 1 ? "flowerMass/RollClothPanel2/nv_mei_tong.png" : "flowerMass/RollClothPanel2/nan_mei_tong.png";
            this.addEvents();
        }

        show(box: any) {
            clientCore.Logger.sendLog('2022年5月6日活动', '【付费】小花仙集合啦', '打开周年扭蛋-节气立夏面板');
            this.setShowInfo(0);
            box.addChild(this);
        ...
        private updateCurrent(): void {
            ...
            if (this.boxCur.visible) {
                this.imgCur.skin = `flowerMass/RollClothPanel2/${this.curDiscount / 10}.png`;
            }
        }
        ...
        private playDiscountAni(discount: number) {
            this.imgNext.skin = `flowerMass/RollClothPanel2/next_${discount / 10}.png`;
            // return new Promise((suc: Function) => {
