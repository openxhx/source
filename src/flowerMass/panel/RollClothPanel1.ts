namespace flowerMass {
     ...
     * 转盘抽衣服
     */
    export class RollClothPanel1 extends ui.flowerMass.panel.RollClothPanel1UI {
        /** 抽奖功能ID*/
        private _poolId: number = 38
        /** 抽奖使用的道具ID*/
        private _costItemId: number = 9900330;
        /**套装ID */
        private _suitId: number = 2100325;
        /**集齐奖励ID */
        private _giftId1: number[] = [1000141 , 1100101];
        //private _giftId2: number = 1100096;
        /**帮助说明id */
        private _ruleId: number = 1139;
        ...
        constructor() {
            ...
            this.imgFaceReward.skin = clientCore.LocalInfo.sex == 1 ? "flowerMass/RollClothPanel1/nv_mei_tong.png" : "flowerMass/RollClothPanel1/nan_mei_tong.png";
            this.addEvents();
        }

        show(box: any) {
            clientCore.Logger.sendLog('2022年4月22日活动', '【付费】小花仙集合啦', '进入周年扭蛋-流行风尚面板');
            this.setShowInfo(0);
            box.addChild(this);
        ...
        private updateCurrent(): void {
            ...
            if (this.boxCur.visible) {
                this.imgCur.skin = `flowerMass/RollClothPanel1/${this.curDiscount / 10}.png`;
            }
        }
        ...
        private updateGrid(cfg: xls.rouletteDraw, index: number): void {
            let item: ui.flowerMass.render.RollClothItem1UI = this.boxItem.getChildAt(index) as ui.flowerMass.render.RollClothItem1UI;
        ...
        private set select(value: number) {
            ...
            let item: ui.flowerMass.render.RollClothItem1UI;
            if (this._select != -1) {
                item = this.boxItem.getChildAt(this._select % len) as ui.flowerMass.render.RollClothItem1UI;
                item.imgSelect.visible = false;
            }
            this._select = select;
            item = this.boxItem.getChildAt(this._select % len) as ui.flowerMass.render.RollClothItem1UI;
        ...
        private playDiscountAni(discount: number) {
            this.imgNext.skin = `flowerMass/RollClothPanel1/next_${discount / 10}.png`;
            // return new Promise((suc: Function) => {
        ...
        private updateGift(): void {
            ...
            //let hasBg: boolean = clientCore.UserHeadManager.instance.getOneInfoById(this._giftId1[0]).have;
