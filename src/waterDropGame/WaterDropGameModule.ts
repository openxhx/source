namespace waterDropGame {
    /**
     * waterDropGame.WaterDropGameModule
     */
    export class WaterDropGameModule extends ui.waterDropGame.WaterDropGameModuleUI {
        ...
        init(d: any) {
            this._info = { stageId: 60136, type: 2 };
            this.boxMove.visible = false;
            this._speed = 6;
            this._score = 0;
            this._waterCnt = 10;
            this.labCnt.text = "剩余：" + this._waterCnt;
            this.labPoint.text = '' + (this._score + 1);
        ...
        private async gameOver() {
            net.sendAndWait(new pb.cs_mini_game_over({ stageId: this._info.stageId, type: this._info.type, score: this._score })).then((data: pb.sc_mini_game_over) => {
        ...
        private sureClose() {
            clientCore.ToolTip.gotoMod(264);
        }
