namespace drawReward {
    /**
     * drawReward.TenRewardPanel
     * 1抽、10连抽奖励 通用 展示
     */
    export class TenRewardPanel extends ui.drawReward.TenRewardPanelUI {
        private _rewardInfoArr:pb.IGodTree[];
        private _reward: ui.drawReward.render.DrawTenItemUI[];
        ...
        public showReward(info: pb.IGodTree[], caller: any, call: Function){
            ...
            this.ani1.once(Laya.Event.COMPLETE, this, () => {
                this.showRewardList(this._rewardInfoArr);
