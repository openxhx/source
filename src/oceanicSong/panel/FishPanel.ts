namespace oceanicSong {
     ...
     * 鱼戏樱畔
     */
    export class FishPanel extends ui.oceanicSong.panel.FishPanelUI implements IPanel {
        ...
        private readonly ACTIVITY_SUIT: number = 2110403;//活动服装
        private readonly MAX_LUCKY: number = 100; //最大幸运值
        private readonly DRAW_ID: number = 1;
        ...
        show(parent: Laya.Sprite): void {
            ...
            clientCore.Logger.sendLog('2021年6月18日活动', '【付费】海洋之歌第二期', '打开鱼戏樱畔面板');
        ...
        async init(sign: number): Promise<void> {
            ...
            this._msg = await this._control.openCardInfo(this.DRAW_ID);
            ...
            this._cls = this._cls || xls.get(xls.openCardDraw).get(this.DRAW_ID);
            ...
            this.txLucky.text = (this._msg.luckNum + '');
        ...
        private resetCard(): void {
            this._isStart = false;
            this._control.resetCard(this.DRAW_ID, new Laya.Handler(this, (data: number[]) => {
        ...
        private onCard(pos: number): void {
            ...
            this._isCard = true;
            this._control.openCard(this.DRAW_ID, pos, new Laya.Handler(this, async (data: pb.sc_flower_field_market_orange_divine) => {
                if (!data) { //失败了
                    this._isCard = false;
                    return;
                }
        ...
        private showCard(card: ui.market.item.CardUI, id: number): void {
            if (id < 10000) {
                ...
                card.ico.skin = `oceanicSong/${['x2', 'x3', 'x5'][index]}.png`;
                card.ico.scale(1, 1);
            }
        }
        ...
        private updateReset(): void {
            ...
            this.btnStart.fontSkin = first ? "oceanicSong/t_y_maoxian.png" : "oceanicSong/reset.png";
            this.btnStart.fontX = first ? 72.5 : 64;
            this.btnStart.fontY = first ? 20 : 8;
        }

        private async openPreview() {
            clientCore.ModuleManager.open('probability.ProbabilityModule', 20);
        }
        ...
        private updateLucky(): void {
            ...
            let height: number = ratio * 221
            this.imgLucky.graphics.clear();
            this.imgLucky.graphics.drawRect(0, 221 - height, 231, height, '#fdc2f3');
            this.txLucky.text = (this._msg.luckNum + '');
        }
    }
}