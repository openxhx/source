namespace happinessFlavour {
    /**
     * 12.17
     * happinessFlavour.ExchangePanel
     */
    export class SnowdriftExchangePanel extends ui.happinessFlavour.panel.SnowdriftExchangePanelUI {
        ...
        init(d: { suitId: number, startId: number, endId: number, iconId: number }) {
            ...
            this.imgSuit.skin = `unpack/happinessFlavour/ExchangePanel/${this.curSuit}_${clientCore.LocalInfo.sex}.png`;
        ...
        /**render设置 */
        private ListRender(item: ui.happinessFlavour.render.ExchangeRenderUI) {
            ...
            if (have1 >= cost[0].v2 && have2 >= cost[1].v2 && !item.imgGot.visible) {
                ...
                item.imgEqual.skin = "happinessFlavour/ExchangePanel/equal1.png";
                item.diTarget.skin = "happinessFlavour/ExchangePanel/di_item1.png";
            } else {
                item.btnExchange.visible = false;
                item.imgEqual.skin = "happinessFlavour/ExchangePanel/equal.png";
                item.diTarget.skin = "happinessFlavour/ExchangePanel/di_item.png";
            }
        }
