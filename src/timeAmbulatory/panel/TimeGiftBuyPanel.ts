namespace timeAmbulatory {
    export class BuyDetailsPanel extends ui.timeAmbulatory.panel.BuyDetailsPanelUI {
        ...
        showInfo(rechargeID: number) {
            ...
            this.txtNeedNum.text = rechargeInfo.cost + '元';
        ...
        private onBuyClick(e: Laya.Event) {
            EventManager.event("TIMEAMBULATORY_GIFT_BUY", this._rechargeID);
