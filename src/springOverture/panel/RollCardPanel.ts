namespace springOverture {
    //占卜翻牌
    export class RollCardPanel extends ui.springOverture.panel.RollCardPanelUI {
        /**套装id */
        private suitId: number = 2110617;
        /**规则id */
        private tips_Id: number = 1018;
        /**概率id */
        private probabilityId: number = 46;
        /**抽奖功能id */
        ...
        async show(box: any) {
            ...
            box.addChild(this);
            clientCore.Logger.sendLog('2022年3月11日活动', '【付费】春日序曲', '打开春日九律-雀屏画羽面板');
        }
        ...
        private updateReset(): void {
            ...
            this.btnReset.skin = first ? "springOverture/RollCardPanel/kai_shi_zhan_bu.png" : "springOverture/RollCardPanel/chong_zhi.png";
        }
        ...
        private showCard(card: ui.bigCharge.render.RollCardRenderUI, id: number): void {
            if (id < 10000) {
                ...
                card.ico.skin = `springOverture/RollCardPanel/${['x2', 'x3', 'x5'][index]}.png`;
