namespace springOverture {
     ...
     * 转盘抽衣服
     */
    export class RollClothPanel extends ui.springOverture.panel.RollClothPanelUI {
        /** 抽奖功能ID*/
        private _poolId: number = 34;
        /** 抽奖使用的道具ID*/
        private _costItemId: number = 9900317;
        /**套装ID */
        private _suitId: number = 2100356;
        /**集齐奖励ID */
        private _giftId: number = 2500073;
        /**帮助说明id */
        ...
        constructor() {
            ...
            this.imgFaceReward.skin = clientCore.LocalInfo.sex == 1 ? "springOverture/RollClothPanel/nv_mei_tong.png" : "springOverture/RollClothPanel/nan_mei_tong.png";
            this.addEvents();
            this.boxChange.visible = false;
        }

        show(box: any) {
            clientCore.Logger.sendLog('2022年3月4日活动', '【付费】春日序曲', '打开春风不知-节气春分面板');
            this.setShowInfo(0);
            box.addChild(this);
        ...
        private onTry(): void {
            clientCore.ModuleManager.open('previewBG.PreviewBGModule', { id: [this._suitId], condition: '' });
        }
        /**打开礼包购买面板 */
        private openBuy(): void {
            alert.showEventBuy([4, 5]);
        }
        ...
        private updateGift(): void {
            ...
            let hasBg: boolean = clientCore.UserHeadManager.instance.getOneInfoById(this._giftId).have;
