namespace rechargeCoin {
     ...
     * 充值购买代币礼包
     */
    export class RechargeCoinModule extends ui.rechargeCoin.RechargeCoinModuleUI {
        ...
        private async setData() {
            ...
            this.labLimit1.text = `本周上限:${1 - timeArr[timeArr.length - 1]}/1`;
            this.btnBuy1.disabled = timeArr[timeArr.length - 1] >= 1;
        }
