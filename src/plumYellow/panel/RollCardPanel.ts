namespace plumYellow {
    export class RollCardPanel extends ui.plumYellow.panel.RollCardPanelUI {
        /**套装id */
        private suitId: number = 2110655;
        /**规则id */
        private tips_Id: number = 1119;
        /**概率id */
        private probabilityId: number = 48;
        /**抽奖功能id */
        ...
        /**遮罩高度 */
        private maskHeight: number = 245;

        private giftArr:number[] = [121034 , 121035];
        ...
        constructor() {
            ...
            this.imgSuit1.skin = `res/rechargeCloth/${this.suitId}_${clientCore.LocalInfo.sex}.png`;
        }
        ...
        async show(box: any) {
            ...
            clientCore.UIManager.setMoneyIds([9900002 , 0]);
            clientCore.UIManager.showCoinBox();
            EventManager.event(CHANGE_TIME, "time_13_26");
            box.addChild(this);
            clientCore.Logger.sendLog('2022年5月13日活动', '【付费】梅子黄时', '打开夏数九九-为你奏鸣面板');
        }
        ...
        private updateReset(): void {
            ...
            this.btnReset.skin = first ? "plumYellow/RollCardPanel/kai_shi_zhan_bu.png" : "plumYellow/RollCardPanel/chong_zhi.png";
        }
        ...
        private showCard(card: ui.bigCharge.render.RollCardRenderUI, id: number): void {
            if (id < 10000) {
                ...
                card.ico.skin = `plumYellow/RollCardPanel/${['x2', 'x3', 'x5'][index]}.png`;
