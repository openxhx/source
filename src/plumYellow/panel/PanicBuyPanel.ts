namespace plumYellow {
     ...
     * 千里莺啼
     */
    export class PanicBuyPanel extends ui.plumYellow.panel.PanicBuyPanelUI {
        private coinId: number = 9900334;
        private readonly suitId: number = 2110662;
        ...
        constructor() {
            ...
            this.img1.skin = `res/rechargeCloth/${this.suitId}_1.png`;
            this.img2.skin = `res/rechargeCloth/${this.suitId}_2.png`;
        }

        private buyInfoRender(item: ui.plumYellow.render.PanicInfoRenderUI) {
        ...
        private offInfoRender(item: ui.plumYellow.render.LimitInfoRenderUI) {
            let off: number = item.dataSource;
            item.imgFlag.skin = (off >= this.curOff && this.curOff > 0) ? "plumYellow/PanicBuyPanel/re_mai_zhong.png" : "plumYellow/PanicBuyPanel/yi_shou_wan.png";
        ...
        async show(box:any) {
            ...
            EventManager.event(CHANGE_TIME, "time_3_16");
            box.addChild(this);
            clientCore.Logger.sendLog('2022年6月2日活动', '【付费】梅子黄时', '打开特卖会-纸术师面板');
        }
        ...
        private setUI() {
            ...
            this.imgOff.skin = `plumYellow/PanicBuyPanel/dang_qian${this.curOff}_zhe.png`;
            this.listOffInfo.refresh();
        }

        /**检查开卖时间 */
        private checkSell(): number {
            let endT: number = util.TimeUtil.formatTimeStrToSec("2022/6/3 20:10:00");
        ...
        private buySuit() {
            ...
            if (have < cost) {
                alert.showSmall(`所需${clientCore.ItemsInfo.getItemName(this.coinId)}不足,是否前往补充?`, { callBack: { funArr: [() => { PlumYellowModel.instance.openCoinGiftBuy() }], caller: this } });
                return;
            }
